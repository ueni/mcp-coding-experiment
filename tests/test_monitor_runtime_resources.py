...
def test_dockerfile_copies_runtime_source_package_helpers() -> None:
    ...
    assert "tool_output_schemas.py tool_catalog_integrity.py tool_catalog_baseline.json agents_context_health.py http_mcp_contract_parity.py version_metadata.py ./source/" in dockerfile
