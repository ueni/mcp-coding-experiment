...
STABLE_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "skill_privilege_scope": ("schema", "read_only", "executed_imported_code", "external_services_called", "summary", "items", "action_nodes", "required_privileges", "advisory_blockers", "governance"),
...
EXPERIMENTAL_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "skill_privilege_scope": ("redacted", "repository_relative_output", "intent_profile", "security"),
...
TOOL_OUTPUT_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "skill_privilege_scope": _object_schema(
        ["schema", "read_only", "executed_imported_code", "external_services_called", "summary", "items", "action_nodes", "required_privileges", "advisory_blockers", "governance"],
        {
