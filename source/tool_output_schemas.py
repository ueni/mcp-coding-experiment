...
STABLE_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "self_optimization_report": ("schema", "report_id", "generated_at", "window", "summary", "metrics", "optimization_candidates", "optimization_integrity_report", "security"),
...
EXPERIMENTAL_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "governance_report": ("window", "git", "snapshots", "security", "workflow_diagnostics", "tool_catalog_integrity", "ci_workflow_security", "untrusted_content_signals", "memory_governance", "lineage", "provenance", "compressed_observation", "_meta"),
...
TOOL_OUTPUT_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "self_optimization_report": _object_schema(
        ["schema", "report_id", "generated_at", "window", "summary", "metrics", "optimization_candidates", "optimization_integrity_report", "security"],
        {
