...
EXPERIMENTAL_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "policy_governance_decision": ("intent", "execution_mode", "data_classification", "step_count", "bundle_id", "bundle_version", "authoritative_hard_gates", "workflow_policy_plan", "security"),
