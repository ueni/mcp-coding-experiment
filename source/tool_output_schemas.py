...
STABLE_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "skill_privilege_scope": ("schema", "read_only", "executed_plan", "executed_imported_code", "external_services_called", "decision", "ok", "summary", "items", "action_nodes", "required_privileges", "advisory_blockers", "suggested_constraints", "governance"),
    ...
    "security_root_cause_evidence": ("schema", "report_id", "generated_at", "base_ref", "head_ref", "status", "ok", "summary", "ranked_locations", "evidence_inputs", "security"),
    ...
    "agent_lifespan_drift_report": ("schema", "report_id", "generated_at", "read_only", "advisory_only", "status", "ok", "summary", "fixtures", "findings", "security", "exports"),
    ...
    "workflow_phase_telemetry": ("schema", "report_id", "generated_at", "read_only", "advisory_only", "summary", "phase_order", "phases", "signals", "privacy"),
...
EXPERIMENTAL_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "policy_simulator": (),
    "workflow_policy_plan": ("intent", "execution_mode", "allowed_targets", "data_classification", "step_count", "steps", "skill_privilege_scope", "security"),
    "skill_privilege_scope": ("redacted", "repository_relative_output", "intent_profile", "item_count", "node_count", "findings", "security"),
    "policy_governance_decision": ("intent", "execution_mode", "data_classification", "step_count", "bundle_id", "bundle_version", "authoritative_hard_gates", "workflow_policy_plan", "skill_privilege_scope", "security"),
    ...
    "release_readiness": ("started_at", "finished_at", "mcp_apps", "checks.security_root_cause_evidence"),
    ...
    "security_root_cause_evidence": ("read_only", "advisory_only", "changed_files", "related_tests", "call_import_neighbors", "shallow_fix_warnings", "limitations", "_meta"),
    "mcp_threat_model_report": ("controls", "baseline", "fixtures", "security", "resource_links", "_meta"),
    "agent_lifespan_drift_report": ("resource_links", "_meta"),
    "governance_report": ("audit", "governance_hooks", "agents_context_health", "exports", "resource_links", "summary", "window", "git", "snapshots", "security", "workflow_diagnostics", "tool_catalog_integrity", "http_mcp_contract_parity", "ci_workflow_security", "agent_security_delta", "secret_exposure", "untrusted_content_signals", "memory_governance", "agent_lifespan_drift", "result_references", "result_mode", "result_reference", "lineage", "provenance", "compressed_observation", "_meta"),
    ...
    "workflow_phase_telemetry": ("window", "anomalies", "optimization_hints", "trace_context", "sources", "security", "_meta"),
...
TOOL_OUTPUT_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "workflow_policy_plan": _object_schema(
        ["schema", "read_only", "executed_plan", "decision", "ok", "plan_id", "blocking_policies", "required_preconditions", "findings", "safe_next_actions"],
        {
            ...
            "safe_next_actions": {"type": "array", "items": {"type": "string"}},
            "skill_privilege_scope": {"type": "object"},
            "security": {"type": "object"},
        },
    ),
    "skill_privilege_scope": _object_schema(
        ["schema", "read_only", "executed_plan", "executed_imported_code", "external_services_called", "decision", "ok", "summary", "items", "action_nodes", "required_privileges", "advisory_blockers", "governance"],
        {
            ...
            "decision": {"type": "string", "enum": ["allow", "needs_constraints"]},
            "ok": {"type": "boolean"},
            "redacted": {"type": "boolean"},
            "repository_relative_output": {"type": "boolean"},
            "intent_profile": {"type": "object"},
    ...
    "security_root_cause_evidence": _object_schema(
        ["schema", "report_id", "generated_at", "base_ref", "head_ref", "status", "ok", "summary", "ranked_locations", "evidence_inputs", "security"],
        {
            "schema": {"type": "string", "const": "security_root_cause_evidence.v1"},
            "report_id": {"type": "string"},
            "generated_at": {"type": "string"},
            "read_only": {"type": "boolean", "const": True},
            "advisory_only": {"type": "boolean", "const": True},
            "base_ref": {"type": "string"},
            "head_ref": {"type": "string"},
            "status": {"type": "string", "enum": ["evidence_found", "insufficient_evidence", "no_changed_files"]},
            "ok": {"type": "boolean"},
            "summary": {"type": "object"},
            "changed_files": {"type": "array", "items": {"type": "string"}},
            "ranked_locations": {"type": "array", "items": {"type": "object"}},
            "related_tests": {"type": "array", "items": {"type": "object"}},
            "call_import_neighbors": {"type": "array", "items": {"type": "object"}},
            "evidence_inputs": {"type": "object"},
    ...
    "agent_lifespan_drift_report": _object_schema(
        ["schema", "report_id", "generated_at", "read_only", "advisory_only", "status", "ok", "summary", "fixtures", "findings", "security", "exports"],
        {
            "schema": {"type": "string", "const": "agent_lifespan_drift_report.v1"},
            "report_id": {"type": "string"},
            "generated_at": {"type": "string"},
            "read_only": {"type": "boolean", "const": True},
            "advisory_only": {"type": "boolean", "const": True},
    ...
    "governance_report": _object_schema(
        ["schema", "report_id", "generated_at"],
        {
            ...
            "http_mcp_contract_parity": {"type": "object"},
            ...
            "memory_governance": {"type": "object"},
            "agent_lifespan_drift": {"type": "object"},
    ...
    "workflow_phase_telemetry": _object_schema(
        ["schema", "report_id", "generated_at", "read_only", "advisory_only", "summary", "phase_order", "phases", "signals", "privacy"],
        {
            "schema": {"type": "string", "const": "workflow_phase_telemetry.v1"},
            "report_id": {"type": "string"},
            "generated_at": {"type": "string"},
            "read_only": {"type": "boolean", "const": True},
            "advisory_only": {"type": "boolean", "const": True},
            ...
            "optimization_hints": {"type": "array", "items": {"type": "object"}},
