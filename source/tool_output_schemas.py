...
EXPERIMENTAL_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "governance_report": ("audit", "governance_hooks", "agents_context_health", "exports", "resource_links", "summary", "window", "git", "snapshots", "security", "workflow_diagnostics", "tool_catalog_integrity", "http_mcp_contract_parity", "ci_workflow_security", "agent_security_delta", "secret_exposure", "untrusted_content_signals", "memory_governance", "result_references", "result_mode", "result_reference", "lineage", "provenance", "compressed_observation", "_meta"),
