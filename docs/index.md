...
- [Workflow skill cards](./workflow-skill-cards.md) - read-only workflow retrieval helper and `workflow_card.v1` schema.
...
- [Workflow skill cards](./workflow-skill-cards.md) (`docs/workflow-skill-cards.md`) - Status: `canonical`
