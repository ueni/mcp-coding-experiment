...
- [Agent lifespan drift report](./agent-lifespan-drift-report.md) - offline longitudinal fixtures for memory/workflow-card revision, interference, compression, and utilization drift.
...
- [Agent lifespan drift report](./agent-lifespan-drift-report.md) (`docs/agent-lifespan-drift-report.md`) - Status: `prototype`
