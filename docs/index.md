...
- [GitHub Actions workflow security report](./ci-workflow-security.md) - offline read-only workflow posture checks for permissions, action refs, risky triggers, runners, Docker/secrets/artifacts, suppressions, and SARIF 2.1.0 export.
- [Dependency security report](./dependency-security.md) - read-only dependency inventory, SARIF/SBOM export, and vulnerability-gate evidence with offline/caller-provided advisory sources.
...
- [Dependency security report](./dependency-security.md) (`docs/dependency-security.md`) - Status: `prototype` (includes offline SARIF/SBOM export)
- [GitHub Actions workflow security report](./ci-workflow-security.md) (`docs/ci-workflow-security.md`) - Status: `prototype` (includes offline SARIF export)
